...
| 🔢 **IPv4 + IPv6 کامل** | آگاه از دو استک: هر دو آدرس عمومی شما (از طریق ipify) را تشخیص می‌دهد و هر آدرس IPv4/IPv6 را استعلام می‌کند |
...
| معکوس‌شدن هنگام hover | جابه‌جایی fg↔bg + `translate(-2px,-2px)` | دکمه‌ها، تب‌ها، چیپ‌ها |
...
به‌ترتیب راحتی: VPN معتبر، مرورگر Tor، یا پروکسی. بعد تب Security را در myip دوباره اجرا کنید تا ببینید هنوز چه چیزی لو می‌رود (WebRTC معمول‌ترین مورد است).
</details>
